                    ...
                    <ul className={style} id="accordionSidebar">
                      ...
                      {/*   <div className="text-center d-none d-md-inline">
                        ...
                        <div className="sidebar-card d-none d-lg-flex">
                            ...
                            <p className="text-center mb-2"><strong>Dashboard</strong> is packed with premium features, components, and more!</p>
                                    ...
                                    <li className="nav-item dropdown no-arrow mx-1">
                                        ...
                                        <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                            ...
                                            <a className="dropdown-item d-flex align-items-center" href="#">
                                                ...
                                                <div>
                                                    <div className="small text-gray-500">July 4, 2023</div>
                                            ...
                                            <a className="dropdown-item d-flex align-items-center" href="#">
                                                ...
                                                <div>
                                                    <div className="small text-gray-500">september 10, 2023</div>
                                                    $530.29 has been deposited into your account!
                                                </div>
                                            </a>
                                            <a className="dropdown-item d-flex align-items-center" href="#">
                                                <div className="mr-3">
                                                ...
                                                <div>
                                                    <div className="small text-gray-500">July 17, 2023</div>
                                        ...
                                        <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                            ...
                                            <a className="dropdown-item d-flex align-items-center" href="#">
                                                ...
                                                <div className="font-weight-bold">
                                                    ...
                                                    <div className="small text-gray-500">User 1 · 58m</div>
                                                </div>
                                            </a>
                                            <a className="dropdown-item d-flex align-items-center" href="#">
                                                <div className="dropdown-list-image mr-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="small text-gray-500">User 2 · 1d</div>
                                                </div>
                                            </a>
                                            <a className="dropdown-item d-flex align-items-center" href="#">
                                                <div className="dropdown-list-image mr-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="small text-gray-500">User 3 · 2d</div>
                                                </div>
                                            </a>
                                            <a className="dropdown-item d-flex align-items-center" href="#">
                                                <div className="dropdown-list-image mr-3">
                                                ...
                                                <div className="row no-gutters align-items-center">
                                                    <div className="col mr-2">
                                                        <div className="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                            Earnings (Annual)</div>
                                                        <div className="h5 mb-0 font-weight-bold text-gray-800">$120,000</div>
                                                    </div>
                                                    <div className="col-auto">
